...
import ActualizarUser from "./components/paginas/ActualizarUser";
  ...
  return (
    ...
    <Routes>
              ...
              <Route path="/ordenes" element={<Ordenes />  } />
                ...
                <Route path="/nuevo-user" element={<DetalleUsuarios/> }/>
                <Route path="/actualizar-producto/:reference" element={< ActualizarProducto/>} />
                <Route path="/actualizar-user/:id" element={< ActualizarUser/>} />
    </Routes>
    </>
