          ...
          Swal.fire({
              ...
              if (result.isConfirmed) {
                  try{ console.log(datos);
                      fetch(`http://localhost:8085/api/cookware/new`, {
                          method: "POST",
...
<div className="md:flex min-h-screen" >
      ...
      <h1 className="text-3xl bg-green-600 text-center text-white font-bold mb-4">AGREGAR PRODUCTOS</h1>
